    ...
    <>
      <div className='w-full h-full flex items-center lg:justify-start py-24 justify-center flex-wrap'>
        <div className='lg:w-3/6 w-full sm:p-2 h-full my-2 flex items-center justify-center px-4 md:items-start md:justify-start md:p-20 flex-col'>
          ...
          <p className='md:text-lg sm:text-sm text-xs mb-20 text-gray-400'>Join over 500 job seekers who use our platform to find the best opportunities every day. Hundreds of new job listinigs added daily!</p>
          <div className='bg-white flex-col mb-6 w-full md:px-4 py-4 flex sm:flex-row items-center justify-center'>
            ...
            <input onChange={(e) => setSearch(e.target.value)} type="text" placeholder='Search Jobs with Job categories like marketing ...' className='xs:w-full w-3/4 h-full px-2 bg-gray-200 text-base py-3 outline-none' aria-label="Search jobs by category" />
            ...
            <button onClick={() => { setSearch(''); setFilteredJobs([]); setDoneSearch(false); }} className="px-3 py-2 border border-gray-400 rounded ml-2">Clear</button>
          </div>
          <div className='w-full px-2 py-2 flex items-center justify-start flex-wrap'>
            <div className='flex items-center justify-center'>
              ...
              <h1 className='font-semibold text-lg'>Popular Job Categoris : </h1>
            </div>
  ...
  <div className="w-5/6 lg:w-3/4 px-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <button
  onClick={() => window.open("https://rzp.io/rzp/IRluIW6", "_blank", "noopener,noreferrer")}
...
>
  Choose Plan
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <button
  onClick={() => window.open("https://rzp.io/rzp/3q9bCLMW", "_blank", "noopener,noreferrer")}
  className="w-full py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-all"
>
  Choose Plan
</button>
