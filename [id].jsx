                    ...
                    <>
                        ...
                        <div className='w-full  py-20 flex items-center md:px-8 px-2  justify-center flex-col  '>
                            ...
                            <div className='flex items-center  justify-center w-full py-10'>
                                <div className='flex w-full px-8 md:px-20 items-center md:flex-row flex-col md:justify-between justify-center'>
                                    <div className='flex-col mb-1 items-center justify-center shadow-slate-700'>
                                        <Image src={"https://xsgames.co/randomusers/avatar.php?g=male"} alt="no-image" className='rounded-full mb-2  drop-shadow-md hover:drop-shadow-xl shadow-slate-700  ' width={200} height={200} />
                                        <div className=' mx-2 flex flex-col items-start justify-center text-center'>
                                            <p className='font-semibold text-base mb-1 text-lg' >{JobDetails?.title} </p>
                                            <p className=' text-md text-gray-800 mb-1 px-2'>{JobDetails?.company}</p>
                                        </div>

                                    </div>
                                    <div className=' h-full md:px-4 mb-1 px-2 md:mx-2 flex  items-center justify-center'>
                                    <div className='md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center bg-slate-300 rounded-xl drop-shadow-md hover:drop-shadow-xl '>
                                    ...
                                    <div className='md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center bg-slate-300 rounded-xl drop-shadow-md hover:drop-shadow-xl shadow-teal-400'>
                                        <div className='flex items-center justify-center mb-1'>
                            ...
                            <div className='w-full md:px-4 py-2 flex items-center md:items-start md:flex-row flex-col justify-center md:justify-center bg-slate-200 mb-12'>
                                <div className=' w-full md: flex flex-col items-center content-start justify-center py-6'>
                                ...
                                <div className='md:w-4/12 w-full py-8 px-4 md:px-10 m-auto flex flex-col items-center '>
                                    <h1 className=' text-2xl font-semibold mb-2 border-b-2 border-indigo-600 mb-4'>Job Summary</h1>
                                    <div class='flex-col items-start justify-center mx-4'>
