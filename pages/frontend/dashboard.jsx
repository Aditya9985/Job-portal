          ...
          <>
            ...
            <div className='w-full h-screen pt-20 flex items-center justify-start flex-col'>
              <div className='flex bg-gray-100 flex-wrap items-center justify-center w-full py-2 px-2'>
                {/* Applied Jobs */}
                <div onClick={() => setShowTable('appliedJobs')} className='py-2 cursor-pointer border-green-600 border-b-2 px-2 w-60 h-32 rounded mx-2 my-2 bg-white flex items-center justify-center'>
                ...
                {/* Saved Jobs */}
                <div onClick={() => setShowTable('savedJobs')} className='py-2 cursor-pointer border-b-yellow-600 border-b-2 px-2 w-60 h-32 rounded mx-2 my-2 bg-white flex items-center justify-center'>
                ...
                {/* AI Resume Logo */}
                <div className='py-2 cursor-pointer border-b-red-600 border-b-2 px-2 w-60 h-32 rounded mx-2 my-2 bg-white flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300'>
                  <Link href="http://localhost:3001/dashboard" className="flex items-center w-full h-full">
                    <img 
                      src="/ai-technology.png" 
                      alt="AI Resume Logo" 
                      className='full w-10 h-10 object-cover' 
                    />
                    <div className='flex flex-col items-start mx-2 justify-start px-2'>
                      <p className='text-xl font-semibold text-gray-800'>AI-Resume</p>
