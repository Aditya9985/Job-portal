...

      {
        loading ? (
          ...
          <div className='bg-gray w-full h-screen flex items-center flex-col justify-center'>
            ...
            <p className='text-xxs uppercase'>Loading Resources Hold Tight...</p>
          </div>
        ) : (
          <>
            <NavBar />
            <div className='w-full h-screen pt-20 flex items-center justify-start flex-col'>
              <div className='flex bg-gray-100 flex-wrap items-center justify-center w-full py-2 px-2'>
                {/* applied Jobs */}
                <div onClick={() => setShowTable('appliedJobs')} className='py-2 cursor-pointer border-indigo-600 border-b-50% px-2 w-60 h-32 rounded-full mx-2 my-2 bg_custom1 flex items-center justify-center hover:bg-cyan-800 ease-in-out duration-500'>
                  ...
                  <div className='flex  flex-col mx-2 items-start justify-start px-2 '>
                    <p className='text-xxl font-semibold ' >Total Applied</p>
                    <p className='text-lg font-semibold text-slate-50'>50+</p>
                  </div>
                </div>

                {/* applied Jobs */}
                <div onClick={() => setShowTable('savedJobs')} className='py-2 cursor-pointer border-b-teal-600 rounded border-b-50% px-2 w-60 h-32 rounded-full mx-2 my-2 bg_custom1 flex items-center justify-center hover:bg-cyan-800 ease-in-out duration-500'>
                  ...
                  <div className='flex  flex-col items-start mx-2 justify-start px-2 '>
                    <p className='text-xxxl font-semibold'>Save Jobs</p>
                    <p className='text-lg font-semibold text-slate-50'>50+</p>
                  </div>
                </div>
              ...
              <div className='w-full h-full px-4 '>
                {
                  showTable === 'savedJobs text-4xl' ? <SavedJobDataTable /> : <AppliedJobDataTable />
                }
              </div>
            </div>
          </>
